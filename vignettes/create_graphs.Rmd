...
```{r}
tic("analysis 3")
res.1.1.city <- SMCA(cheese, c1 = c1[1], c2 = c2[1], Grow = Gcity, n = 10, init="svd")
res.1.2.city <- SMCA(cheese, c1 = c1[1], c2 = c2[2], Grow = Gcity, n = 10, init="svd")
res.1.3.city <- SMCA(cheese, c1 = c1[1], c2 = c2[3], Grow = Gcity, n = 10, init="svd")
res.2.1.city <- SMCA(cheese, c1 = c1[2], c2 = c2[1], Grow = Gcity, n = 10, init="svd")
res.2.2.city <- SMCA(cheese, c1 = c1[2], c2 = c2[2], Grow = Gcity, n = 10, init="svd")
res.2.3.city <- SMCA(cheese, c1 = c1[2], c2 = c2[3], Grow = Gcity, n = 10, init="svd")
res.3.1.city <- SMCA(cheese, c1 = c1[3], c2 = c2[1], Grow = Gcity, n = 10, init="svd")
res.3.2.city <- SMCA(cheese, c1 = c1[3], c2 = c2[2], Grow = Gcity, n = 10, init="svd")
toc()
```
...
```{r}
tic("analysis 4")
res.1.1.city.var <- SMCA(cheese, c1 = c1[1], c2 = c2[1], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.1.2.city.var <- SMCA(cheese, c1 = c1[1], c2 = c2[2], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.1.3.city.var <- SMCA(cheese, c1 = c1[1], c2 = c2[3], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.2.1.city.var <- SMCA(cheese, c1 = c1[2], c2 = c2[1], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.2.2.city.var <- SMCA(cheese, c1 = c1[2], c2 = c2[2], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.2.3.city.var <- SMCA(cheese, c1 = c1[2], c2 = c2[3], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.3.1.city.var <- SMCA(cheese, c1 = c1[3], c2 = c2[1], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
res.3.2.city.var <- SMCA(cheese, c1 = c1[3], c2 = c2[2], Gcol = Gvar, Grow = Gcity, n = 10, init="svd")
toc()
```
...
screeplot_cum(res2, names.res = names2, title = "Screeplots without group constraint")
```
